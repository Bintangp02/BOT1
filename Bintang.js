...
/*====================================================[ CASE BY NAYLA ]==============================================================*/                    	 
         ...
         case 'welcome':  
					...
					welkom.push(from)
					fs.writeFileSync('./Bintang/welkom.json', JSON.stringify(welkom))
        ...
        case 'antilink':  
					...
					antilink.push(from)
					fs.writeFileSync('./Bintang/antilink.json', JSON.stringify(antilink))
		...
		case 'botx':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					botx.push(from)
					fs.writeFileSync('./Bintang/botx.json', JSON.stringify(botx))
		...
		case 'antigay':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					antigay.push(from)
					fs.writeFileSync('./Bintang/antigay.json', JSON.stringify(antigay))
		...
		case 'antibocil':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					antibocil.push(from)
					fs.writeFileSync('./Bintang/antibocil.json', JSON.stringify(antibocil))
		...
		case 'antiwibu':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					antiwibu.push(from)
					fs.writeFileSync('./Bintang/antiwibu.json', JSON.stringify(antiwibu))
		...
		case 'antikasar':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					nayXi.push(from)
					fs.writeFileSync('./Bintang/BintangXi.json', JSON.stringify(nayXi))
		...
		case 'antitag':  
					...
					if (isEventon) return reply('*SUDAH AKTIF* !!!')
					nayXix.push(from)
					fs.writeFileSync('./Bintang/Bintang.json', JSON.stringify(nayXix))
